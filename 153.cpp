// Singly  Linear Circular Linked List  with C++
#include<iostream>
using namespace std;
...
class SinglyCLL         // Characteristic
{
     private:
     PNODE Head;    
     PNODE Tail;
...
void SinglyCLL::DeleteLast()
{
     ...
     else if(Head ==Tail)    // If LL contains more than 1 node
     {
          delete Head;
          Head = NULL;
          Tail = NULL;
     ...
     else   //If contains more than 1 node
     {
          PNODE temp = Head;
...
int main()
{
     ...
     cout<<"Nmber of nodes are: "<<iRet<<endl;
